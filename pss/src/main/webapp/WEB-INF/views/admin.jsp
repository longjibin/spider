...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<iframe id="contentFrame" name="contentFrame" src="https://www.baidu.com" frameborder=no width="100%" scrolling="no" height=100% onload="javascript:reinitIframe();"></iframe>
		</div>
		<!-- /.content-wrapper -->
