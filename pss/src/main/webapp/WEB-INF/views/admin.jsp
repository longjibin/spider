...
<body class="hold-transition skin-blue sidebar-mini">
										...
										<div class="direct-chat-messages">
											...
											<div class="direct-chat-msg">
												...
												<img class="direct-chat-img"
													src="${ctx }/static/plugins/adminlte/img/user1-128x128.jpg" alt="message user image">
												<!-- /.direct-chat-img -->
											...
											<div class="direct-chat-msg right">
												...
												<!-- /.direct-chat-info -->
												<img class="direct-chat-img"
													src="${ctx }/static/plugins/adminlte/img/user3-128x128.jpg" alt="message user image">
												<!-- /.direct-chat-img -->
										...
										<div class="direct-chat-contacts">
											<ul class="contacts-list">
												<li><a href="#"> <img class="contacts-list-img"
														src="${ctx }/static/plugins/adminlte/img/user1-128x128.jpg" alt="User Image">
												...
												<!-- End Contact Item -->
												<li><a href="#"> <img class="contacts-list-img"
														src="${ctx }/static/plugins/adminlte/img/user7-128x128.jpg" alt="User Image">
												...
												<!-- End Contact Item -->
												<li><a href="#"> <img class="contacts-list-img"
														src="${ctx }/static/plugins/adminlte/img/user3-128x128.jpg" alt="User Image">
												...
												<!-- End Contact Item -->
												<li><a href="#"> <img class="contacts-list-img"
														src="${ctx }/static/plugins/adminlte/img/user5-128x128.jpg" alt="User Image">
												...
												<!-- End Contact Item -->
												<li><a href="#"> <img class="contacts-list-img"
														src="${ctx }/static/plugins/adminlte/img/user6-128x128.jpg" alt="User Image">
												...
												<!-- End Contact Item -->
												<li><a href="#"> <img class="contacts-list-img"
														src="${ctx }/static/plugins/adminlte/img/user8-128x128.jpg" alt="User Image">
								...
								<ul class="products-list product-list-in-box">
									<li class="item">
										<div class="product-img">
											<img src="${ctx }/static/plugins/adminlte/img/default-50x50.gif" alt="Product Image">
										</div>
	...
	<script src="${ctx }/static/plugins/adminlte/js/pages/dashboard2.js"></script>
	<!-- AdminLTE for demo purposes -->
	<script src="${ctx }/static/plugins/adminlte/js/demo.js"></script>
</body>
</html>
