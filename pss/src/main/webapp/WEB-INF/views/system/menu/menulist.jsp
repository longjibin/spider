						...
						<div class="box box-primary">
							<div class="box-body box-profile">
								<img class="profile-user-img img-responsive img-circle"
									src="${ctx }/static/plugins/adminlte/img/user4-128x128.jpg"
								...
								<div class="active tab-pane" id="activity">
									...
									<div class="post">
										...
										<div class="row margin-bottom">
											<div class="col-sm-6">
												<img class="img-responsive" src="${ctx }/static/plugins/adminlte/img/photo1.png"
													alt="Photo">
											</div>
											<!-- /.col -->
											<div class="col-sm-6">
												<div class="row">
													<div class="col-sm-6">
														<img class="img-responsive"
															src="${ctx }/static/plugins/adminlte/img/photo2.png" alt="Photo"> <br>
														<img class="img-responsive"
															src="${ctx }/static/plugins/adminlte/img/photo3.jpg" alt="Photo">
													</div>
													<!-- /.col -->
													<div class="col-sm-6">
														<img class="img-responsive"
															src="${ctx }/static/plugins/adminlte/img/photo4.jpg" alt="Photo"> <br>
														<img class="img-responsive"
															src="${ctx }/static/plugins/adminlte/img/photo1.png" alt="Photo">
													</div>
													<!-- /.col -->
												</div>
												<!-- /.row -->
